window.siteContent = {
  ...
  intro: {
    title: "Наша команда создаёт такие системы. Те же люди. Другой потолок.",
    text: "Системы позволяют вашей команде работать эффективнее, и бизнес получает возможность расти без новых позиций в штате.",
    cards: [
      {
        title: "Минимум лишних данных",
        text: "Собираем в форме только то, что нужно для обратной связи и первичной квалификации запроса."
      },
      {
        title: "Решения под задачу",
        text: "AI, CRM, сайт, Telegram-бот или внутренняя панель — выбираем не тренд, а рабочий инструмент."
      },
      {
        title: "Прозрачный контур",
        text: "Документы, обработка запросов и интерфейс формы собраны так, чтобы сайт было легче довести до production."
      }
    ],
  ...
  services: {
    eyebrow: "Услуги",
    title: "Какие задачи мы закрываем",
    text: "На этом наш опыт не заканчивается. Ниже — задачи и системы, которые мы можем реализовать для Вас",
    cards: [
      {
  ...
  process: {
    ...
    steps: [
      {
        title: "Анализ задачи",
        text: "Изучаем, как сейчас устроена работа: где теряется время, возникают ошибки и появляются лишние расходы. Определяем, что есть смысл автоматизировать"
      },
      {
        title: "Поиск решения и расчет ROI",
        text: "Считаем экономику внедрения: сколько ресурсов теряется сейчас, где автоматизация даст эффект и за какой срок окупится решение"
      },
      {
        title: "Сборка MVP и пилот",
        text: "Запускаем ограниченную версию системы на реальном процессе, проверяем сценарии работы и собираем обратную связь"
      },
      {
        title: "Интеграция в рабочие процессы",
        text: "Полноценно встраиваем инструмент в повседневную работу Вашей команды"
      },
      {
        title: "Поддержка и развитие",
        text: "После запуска отслеживаем стабильность системы и улучшаем пользовательский опыт"
      }
    ]
  },
  quote: {
    textHtml: "Не доверяете ИИ?<br> Мы предлагаем <span class=\"quote-break__accent\">безопасный запуск</span>: сначала разрабатываем решение, а дальше Вы пользуетесь им по подписке с возможностью остановить её в любой момент.",
    action: "Обсудить задачу"
  },
  footer: {
    tagline: "AI-системы, автоматизация и внутренние цифровые контуры — для команд, которые хотят работать умнее.",
    navTitle: "Навигация",
    navLinks: ["Кейсы", "Что делаем", "Процесс", "Написать нам"],
