window.siteContent = {
  ...
  quote: {
    textHtml: "Не доверяете ИИ? <span class=\"quote-break__accent\">Мы предлагаем безопасный запуск:</span> сначала разрабатываем решение, а дальше Вы пользуетесь им по подписке с возможностью остановить её в любой момент.",
    action: "Обсудить задачу"
  },
  footer: {
