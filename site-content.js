window.siteContent = {
  ...
  quote: {
    textHtml: "Не доверяете ИИ?<br><em>Мы предлагаем Вам подписочный формат: <br> сначала разрабатываем решение, а после запуска Вы сможете пользоваться им по подписке с возможностью отказаться в любой момент</em>",
    action: "Обсудить задачу"
  },
  footer: {
